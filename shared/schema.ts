...
export const swiggyPos = pgTable("swiggy_po_header", {
  ...
  facility_id: varchar("facility_id", { length: 50 }),
  facility_name: varchar("facility_name", { length: 255 }),
  city: varchar("city", { length: 100 }),
  po_date: timestamp("po_date"),
  po_modified_at: timestamp("po_modified_at"),
  ...
  otb_reference_number: varchar("otb_reference_number", { length: 255 }),
  internal_external_po: varchar("internal_external_po", { length: 50 }),
  total_items: integer("total_items").default(0),
  total_quantity: integer("total_quantity").default(0),
...
export const swiggyPoLines = pgTable("swiggy_po_lines", {
  ...
  otb_reference_number: varchar("otb_reference_number", { length: 255 }),
  internal_external_po: varchar("internal_external_po", { length: 50 }),
  po_ageing: integer("po_ageing").default(0),
  reference_po_number: varchar("reference_po_number", { length: 100 }),
  created_at: timestamp("created_at").defaultNow(),
});
