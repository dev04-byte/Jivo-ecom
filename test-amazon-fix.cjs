  ...
  try {
    ...
    const testData = {
      header: {
        ...
        po_date: new Date('2024-09-01').toISOString(),
        shipment_date: null,
        delivery_date: new Date('2024-10-01').toISOString(),
      ...
      lines: [
        {
          ...
          net_amount: "500.00",
          supplier_reference: "",
          expected_delivery_date: new Date('2024-10-01').toISOString()
        },
        {
          line_number: 2,
          asin: "B00TEST456",
    ...
    const response = await fetch('http://localhost:5001/api/amazon-pos/import', {
      method: 'POST',
      headers: {
