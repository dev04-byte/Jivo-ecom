...
import { SearchableSAPItemInput } from "@/components/po/searchable-sap-item-input";
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="space-y-2">
                  ...
                  <SearchableSAPItemInput
                    value={formData.sap_id}
                    onChange={(value, sapItem) => {
                      // When a SAP item is selected, update sap_id with the item code
